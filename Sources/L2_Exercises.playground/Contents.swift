...
var movie = "Point Breaka"
var director = moviesDict[movie]

//var unwrapped = director!
...
moviesDict["abcd212e3f"] = "abcdef"
moviesDict["abcdef"] = "abcdef"
moviesDict["abcde3f"] = "abcdef"
moviesDict["abcd2e3f"] = "abcdef"
print(moviesDict)
...
var number1 = String(numericalString1)
print("\(number1) is not the magic number.")
//: ### Exercise 4
...
//if let childViewController = UIViewController() {
//    print("true")
//}
